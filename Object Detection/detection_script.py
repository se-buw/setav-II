...
class ObjectDetection:
	...
	def callback(msg):
		...
		#process.start()
		ObjectDetection.object_detection(img,list1)
	...
	def object_detection(img,list1):
		...
		visualize.visualize(list1,pred,img,ObjectDetection.names,ObjectDetection.colors)
...
def main(args=None):
		...
		ObjectDetection()
		subscription=node.create_subscription(CompressedImage,'/image_raw/compressed',ObjectDetection.callback,10)
		rclpy.spin(node)
		node.destroy_node()
		rclpy.shutdown()
