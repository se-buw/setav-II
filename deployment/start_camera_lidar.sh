...
echo "raspbery ip: $1"
gnome-terminal -- bash -c "sshpass -pmaker ssh -t raspi@${1} 'cd ~/lane/Lane*; . install/setup.bash; cd launch; ros2 launch lane_detection_using_sliding_window.py;  bash'; exec bash"
